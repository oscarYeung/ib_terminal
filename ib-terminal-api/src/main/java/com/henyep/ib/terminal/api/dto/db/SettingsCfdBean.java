...
public class SettingsCfdBean{

	private String symbol;
	private String currency;
	private Double amount_per_unit;
	...
	public void setAmount_per_unit(Double amount_per_unit){
		this.amount_per_unit = amount_per_unit;
	}
	public Double getAmount_per_unit(){
	...
	public String toString(){
		...
		builder.append("amount_per_unit: " + amount_per_unit + ", ");
		if(start_date != null)
